...
export default {
  ...
  data() {
    return {
      ...
      apiUrl: 'https://629d30e03798759975e10eeb.mockapi.io/api/v1/postusers',
    }
  },
  methods: {
    getInitialData() {
    ...
    async onSubmit() {
      try {
        const response = await this.axios.post(this.apiUrl, this.model, { 'content-type': 'application/json' });
